(function ( win, doc, PKAE ) {
	...
	**/
	...
	/**
	*	Envoltorio para la función privada openMenu
	**/
	...
	*	@param	function correr cuando sea elegido
	*	@param	if esto está configurado, luego agregue el HTML en lugar de su nombre en su posición
	*	@param	initialization código que se ejecutará cuando el objeto se agregue al dom
	**/
	...
	// ¿También puedes tocar los controles? ####
