(function( w, d, PKAE ) {
	...
	function KeyHandler () {
		...
		q.callbacks       = {}; // devoluciones de llamada para cuando una combinación de claves se activa
		q.singleCallbacks = {}; // devoluciones de llamada al evento 'pulsación de tecla' - no es necesario
